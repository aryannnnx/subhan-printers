<?php
// ============================================
// ADMIN: Portfolio List - Subhan Printers
// ============================================
...
if (isset($_GET['delete']) && isset($_GET['id'])) {
    ...
    if ($result['success']) {
        header('Location: /SP/admin/portfolio/index.php?msg=deleted');
        exit;
    }
}
...
<main class="main-content">
    ...
    <header class="top-header">
        <h1>Manage <span>Portfolio</span></h1>
    ...
    <div class="action-bar">
        <div>
            <span style="color:#8888aa;">Total Items: <strong style="color:#e8e8f0;"><?php echo count($items); ?></strong></span>
        </div>
        <a href="/SP/admin/portfolio/add.php" class="btn-add">
    ...
    <div class="table-wrap">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <?php 
                        $imageUrl = !empty($item['primary_image']) ? $item['primary_image']['url'] : (!empty($item['images'][0]['url']) ? $item['images'][0]['url'] : 'https://placehold.co/50x50/1a1a2e/8b5cf6?text=' . urlencode($item['title'] ?? ''));
                        ?>
                        <img src="<?php echo htmlspecialchars($imageUrl); ?>" alt="<?php echo htmlspecialchars($item['title'] ?? ''); ?>" class="thumbnail">
                    </td>
                    <td>
                        <strong><?php echo htmlspecialchars($item['title'] ?? ''); ?></strong>
                        <?php if (!empty($item['subtitle'])): ?>
                        <div style="font-size:0.75rem;color:#555577;"><?php echo htmlspecialchars($item['subtitle']); ?></div>
                        <?php endif; ?>
                    </td>
                    <td>
                        <span class="category-badge"><?php echo ucfirst(htmlspecialchars($item['category'] ?? 'General')); ?></span>
                    </td>
                    <td>
                        <span class="badge-status <?php echo ($item['is_active'] ?? 1) ? 'badge-active' : 'badge-inactive'; ?>">
                    ...
                    <td style="text-align:right;">
                        <div class="action-btns" style="justify-content:flex-end;">
                            <a href="/SP/admin/portfolio/edit.php?id=<?php echo $item['id']; ?>" class="btn-edit">
                                <i class="fas fa-edit"></i>
                            </a>
                            <a href="/SP/admin/portfolio/index.php?delete=1&id=<?php echo $item['id']; ?>" 
                               class="btn-delete" 
        ...
        <div class="empty-state">
            ...
            <a href="/SP/admin/portfolio/add.php" class="btn-add" style="margin-top:16px;">
