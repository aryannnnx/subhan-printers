<?php
// ============================================
// ADMIN: Add Service - Subhan Printers
// ============================================
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($name) || empty($category)) {
        ...
        if ($result['success']) {
            header('Location: /SP/admin/services/index.php?msg=added');
            exit;
        } else {
            $error = $result['error'] ?? 'Failed to add service.';
        }
    }
}
?>
...
<head>
    ...
    <style>
        /* Same styles as portfolio/add.php */
    ...
    <div class="form-card">
        <form method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" placeholder="e.g., Offset Printing" required value="<?php echo isset($_POST['name']) ? htmlspecialchars($_POST['name']) : ''; ?>">
            </div>

            <div class="form-group">
                <label>Description</label>
                <textarea name="description" placeholder="Service description"><?php echo isset($_POST['description']) ? htmlspecialchars($_POST['description']) : ''; ?></textarea>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="icon" placeholder="fa-print" value="<?php echo isset($_POST['icon']) ? htmlspecialchars($_POST['icon']) : 'fa-print'; ?>">
                ...
                <div class="form-group">
                    ...
                    <select name="category" required>
                        ...
                        <option value="<?php echo $value; ?>" <?php echo (isset($_POST['category']) && $_POST['category'] === $value) ? 'selected' : ''; ?>>
                            <?php echo $label; ?>
                        </option>
                        <?php endforeach; ?>
                    </select>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" name="starting_price" placeholder="0" step="0.01" required value="<?php echo isset($_POST['starting_price']) ? htmlspecialchars($_POST['starting_price']) : ''; ?>">
                </div>
                <div class="form-group">
                    <label>Price Text</label>
                    <input type="text" name="price_text" placeholder="/ 500 pcs, starting, / piece" value="<?php echo isset($_POST['price_text']) ? htmlspecialchars($_POST['price_text']) : ''; ?>">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="features" placeholder="High Quality, Bulk Pricing, Fast Delivery" value="<?php echo isset($_POST['features']) ? htmlspecialchars($_POST['features']) : ''; ?>">
                    <div class="hint">Comma separated values</div>
                </div>
                <div class="form-group">
                    <label>Badge / Tag</label>
                    <input type="text" name="badge" placeholder="⭐ Popular, 🔥 Bestseller" value="<?php echo isset($_POST['badge']) ? htmlspecialchars($_POST['badge']) : ''; ?>">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" name="min_quantity" placeholder="500" value="<?php echo isset($_POST['min_quantity']) ? htmlspecialchars($_POST['min_quantity']) : ''; ?>">
                </div>
                <div class="form-group">
                    <label>Turnaround Time</label>
                    <input type="text" name="turnaround" placeholder="3-5 days" value="<?php echo isset($_POST['turnaround']) ? htmlspecialchars($_POST['turnaround']) : ''; ?>">
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="checkbox-group">
                    <input type="checkbox" name="show_in_pricing" id="show_in_pricing" <?php echo isset($_POST['show_in_pricing']) && $_POST['show_in_pricing'] ? 'checked' : ''; ?>>
