<?php
// ============================================
// ADMIN: Products List - Subhan Printers
// ============================================
...
if (isset($_GET['delete']) && isset($_GET['id'])) {
    ...
    if ($result['success']) {
        header('Location: /SP/admin/products/index.php?msg=deleted');
        exit;
    }
}
...
if (isset($_GET['toggle_featured']) && isset($_GET['id'])) {
    $id = (int)$_GET['id'];
    $result = $productModel->toggleFeatured($id);
    if ($result['success']) {
...
<main class="main-content">
    ...
    <div class="action-bar">
        <div>
            <span style="color:#8888aa;">Total Products: <strong style="color:#e8e8f0;"><?php echo count($products); ?></strong></span>
        </div>
        <a href="/SP/admin/products/add.php" class="btn-add">
    ...
    <div class="table-wrap">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        $imageUrl = !empty($product['image_url']) 
                            ? '/SP/' . ltrim($product['image_url'], '/') 
                            : 'https://placehold.co/50x50/1a1a2e/8b5cf6?text=' . urlencode($product['name'] ?? '');
                        ?>
                        <img src="<?php echo htmlspecialchars($imageUrl); ?>" 
                             alt="<?php echo htmlspecialchars($product['name'] ?? ''); ?>" 
                             class="thumbnail"
                             onerror="this.src='https://placehold.co/50x50/1a1a2e/8b5cf6?text=<?php echo urlencode($product['name'] ?? ''); ?>'">
                    </td>
                    <td>
                        <strong><?php echo htmlspecialchars($product['name'] ?? ''); ?></strong>
                        <?php if (!empty($product['description'])): ?>
                        <div style="font-size:0.75rem;color:#555577;"><?php echo htmlspecialchars(substr($product['description'], 0, 50)) . '...'; ?></div>
                        <?php endif; ?>
                    </td>
                    <td>
                        <?php 
                    ...
                    <td>
                        <div class="product-price">₨ <?php echo number_format($product['starting_price'] ?? 0, 0); ?></div>
                        <?php if (!empty($product['price_text'])): ?>
                        <div style="font-size:0.7rem;color:#555577;"><?php echo htmlspecialchars($product['price_text']); ?></div>
                        <?php endif; ?>
                    </td>
                    <td>
                        <?php if (!empty($product['badge'])): ?>
                        <span class="badge-product"><?php echo htmlspecialchars($product['badge']); ?></span>
                        <?php else: ?>
                    ...
                    <td>
                        ...
                        <a href="/SP/admin/products/index.php?toggle_featured=1&id=<?php echo $product['id']; ?>" 
                           class="badge-featured" style="text-decoration:none;display:inline-flex;align-items:center;gap:4px;">
                            <i class="fas fa-star"></i> Featured
                        </a>
                        <?php else: ?>
                        <a href="/SP/admin/products/index.php?toggle_featured=1&id=<?php echo $product['id']; ?>" 
                           style="color:#555577;font-size:0.7rem;text-decoration:none;display:inline-flex;align-items:center;gap:4px;">
                            <i class="fas fa-star"></i> Set Featured
                        </a>
                        <?php endif; ?>
                    </td>
                    <td>
                        <span class="badge-status <?php echo ($product['is_active'] ?? 1) ? 'badge-active' : 'badge-inactive'; ?>">
                            <?php echo ($product['is_active'] ?? 1) ? 'Active' : 'Inactive'; ?>
                        </span>
                    </td>
                    <td style="text-align:right;">
                        <div class="action-btns" style="justify-content:flex-end;">
                            <a href="/SP/admin/products/edit.php?id=<?php echo $product['id']; ?>" class="btn-edit">
                                <i class="fas fa-edit"></i>
                            </a>
                            <a href="/SP/admin/products/index.php?delete=1&id=<?php echo $product['id']; ?>" 
                               class="btn-delete" 
        ...
        <div class="empty-state">
            ...
            <a href="/SP/admin/products/add.php" class="btn-add" style="margin-top:16px;">
