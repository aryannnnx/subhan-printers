<?php
// ============================================
// ADMIN: Edit Product - Subhan Printers
// ============================================
...
if (!$product) {
    header('Location: /SP/admin/products/index.php');
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($name) || empty($category)) {
        ...
        if ($result['success']) {
            header('Location: /SP/admin/products/index.php?msg=updated');
            exit;
        } else {
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .image-preview {
            margin-top: 12px;
            display: <?php echo !empty($product['image_url']) ? 'block' : 'none'; ?>;
        }
        .image-preview img {
            max-width: 200px;
            max-height: 150px;
...
<aside class="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li><a href="/SP/admin/products/" class="active"><i class="fas fa-cube"></i><span>Products</span></a></li>
...
<main class="main-content">
    ...
    <a href="/SP/admin/products/" class="back-link">
    ...
    <div class="form-card">
        <form method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" placeholder="e.g., Wedding Cards" required value="<?php echo htmlspecialchars($product['name'] ?? ''); ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <div class="current-image">
                    Current Image: <a href="/SP/<?php echo $product['image_url']; ?>" target="_blank"><?php echo basename($product['image_url']); ?></a>
                </div>
                <div class="image-preview" style="display:block;">
                    <img src="/SP/<?php echo $product['image_url']; ?>" alt="Current Image">
                </div>
                <?php endif; ?>
                
                <div class="image-upload-wrap" id="imageUploadWrap">
                    <div class="icon"><i class="fas fa-cloud-upload-alt"></i></div>
                    <p><?php echo !empty($product['image_url']) ? 'Click to change image' : 'Click to upload product image'; ?></p>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="icon" placeholder="fa-heart" value="<?php echo htmlspecialchars($product['icon'] ?? ''); ?>">
                    <div class="hint">e.g., fa-heart, fa-box-open, fa-image</div>
                </div>
                <div class="form-group">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" name="starting_price" placeholder="0" step="0.01" required value="<?php echo htmlspecialchars($product['starting_price'] ?? 0); ?>">
                </div>
                <div class="form-group">
                    <label>Price Text</label>
                    <input type="text" name="price_text" placeholder="/ 50 cards, / piece (bulk)" value="<?php echo htmlspecialchars($product['price_text'] ?? ''); ?>">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" name="min_quantity" placeholder="50" value="<?php echo htmlspecialchars($product['min_quantity'] ?? 0); ?>">
                </div>
                <div class="form-group">
                    <label>Turnaround Time</label>
                    <input type="text" name="turnaround" placeholder="3-5 days" value="<?php echo htmlspecialchars($product['turnaround'] ?? ''); ?>">
                </div>
            </div>

            <div class="form-group">
                <label>Badge / Tag</label>
                <input type="text" name="badge" placeholder="⭐ Popular, 🔥 Bestseller" value="<?php echo htmlspecialchars($product['badge'] ?? ''); ?>">
            </div>

            <div class="form-row">
                <div class="checkbox-group">
                    <input type="checkbox" name="featured" id="featured" <?php echo ($product['featured'] ?? 0) ? 'checked' : ''; ?>>
                    <label for="featured" style="margin:0;">Featured Product</label>
                </div>
                <div class="checkbox-group">
                    <input type="checkbox" name="show_in_pricing" id="show_in_pricing" <?php echo ($product['show_in_pricing'] ?? 1) ? 'checked' : ''; ?>>
            ...
            <div style="display:flex;gap:12px;margin-top:24px;flex-wrap:wrap;">
                ...
                <a href="/SP/admin/products/" class="btn-cancel">
