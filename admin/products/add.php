<?php
// ============================================
// ADMIN: Add Product - Subhan Printers
// ============================================
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($name) || empty($category)) {
        ...
        if ($result['success']) {
            header('Location: /SP/admin/products/index.php?msg=added');
            exit;
        } else {
    ...
    <div class="form-card">
        <form method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea name="description" placeholder="Product description"><?php echo isset($_POST['description']) ? htmlspecialchars($_POST['description']) : ''; ?></textarea>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="icon" placeholder="fa-heart" value="<?php echo isset($_POST['icon']) ? htmlspecialchars($_POST['icon']) : ''; ?>">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="price_text" placeholder="/ 50 cards, / piece (bulk)" value="<?php echo isset($_POST['price_text']) ? htmlspecialchars($_POST['price_text']) : ''; ?>">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" name="min_quantity" placeholder="50" value="<?php echo isset($_POST['min_quantity']) ? htmlspecialchars($_POST['min_quantity']) : ''; ?>">
                </div>
                <div class="form-group">
